...
<template>
  <USlideover :ui="{
    ...
    <div class="flex flex-col h-screen">
      <div class="p-4 flex  justify-between items-center gap-2 bg-slate-50 dark:bg-gray-950" v-if="roomDetail">
        ...
        <div class="flex flex-col px-3">
          ...
          <div v-if="replyChat" class="pl-8 pb-2 relative pr-4">
            <div class="absolute right-4">
              <UButton icon="material-symbols:close-rounded" class="rounded-full text-red-900" size="sm"
                :variant="'link'" @click="cancelReplyChat" />
            </div>
