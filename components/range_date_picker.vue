...
<template>
    <UPopover :popper="{ placement: 'bottom-start' }">
        <div class="flex">
            <UButton icon="i-heroicons-calendar-days-20-solid" class="w-full" :variant="props.variant"
        ...
        <template #panel="{ close }">
            <div class="flex items-center divide-x divide-gray-200 dark:divide-gray-800 ">
                <VDatePicker v-model.range="range" mode="date" :is-dark="app.isDark" :min-date="props.minDate"
                    :max-date="props.maxDate" @close="close" />
            </div>
        </template>
    </UPopover>
</template>
