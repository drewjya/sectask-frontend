...
<template>
  <UForm :ref="props.form.ref" :state="props.form.state" :schema="props.form.schema" :validate-on="['submit']"
    @keydown.enter="$event.preventDefault()" @submit="props.form.submitEvent" @error="onError">
    <!-- hiddenbtn -->
